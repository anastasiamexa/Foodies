<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchCuisine.aspx.cs" Inherits="Spoonacular.SearchCuisine" %>
...
<link rel="stylesheet" href="Recipes.css" media="screen">
    ...
    <script>
        // Get recipe's sourceUrl according to its id
        ...
        // Get recipes based on the selected country/ies
        function getrecipe() {
            var rslt = document.getElementById("result").innerHTML;
                    ...
                    res.results.forEach((element) => {
                        ...
                        r.innerHTML = `
                                                  ...
                                                  <div style="margin: 24px 0;">
                                                    <a href="SearchCuisine.aspx?result=${rslt}&id=${element.id}" runat="server"><i class="fa fa-heart"></i></a>
                                                  </div>
...
<body class="u-body u-xl-mode"><header class="u-clearfix u-header u-sticky u-sticky-fe8d u-header navbar-fixed-top" id="sec-3d90"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_c072">
        <p class="u-text u-text-1" >Showing recipes:</p>
        <asp:Label ID="result" Text="Searching for" ForeColor="#FCFCF7" runat="server" />
