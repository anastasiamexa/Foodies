<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="Spoonacular.Signup" %>
...
<body class="u-body u-xl-mode"><header class="u-clearfix u-header u-sticky u-sticky-fe8d u-header navbar-fixed-top" id="sec-3d90"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-section-1" id="sec-2d2e" data-image-width="1920" data-image-height="1200">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-custom-font u-font-montserrat u-text u-text-default u-text-palette-2-base u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1000">Sign up Form</h2>
          ...
          <div class="u-container-layout u-valign-bottom u-container-layout-1">
            <div class="u-form u-login-control u-form-1">
              <form action="#" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" runat="server">
                ...
                <div class="u-form-group u-form-name u-label-top">
                  <label for="confirm" class="u-label u-label-1">Confirm password *</label>
                  <asp:TextBox type="password" placeholder="Retype your password" id="confirm" name="confirm" class="u-border-8 u-border-white u-input u-input-rectangle u-radius-50 u-white u-input-1" required="" runat="server"> </asp:TextBox>
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="confirm" ErrorMessage="Please enter valid password" ForeColor="Red" ValidationExpression="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,20}$">  </asp:RegularExpressionValidator>
                </div>
                <div class="u-form-group u-form-password u-label-top">
                  <label for="email" class="u-label u-label-2">Email *</label>
                  <asp:TextBox placeholder="Enter your Email" id="email" name="email" class="u-border-8 u-border-white u-input u-input-rectangle u-radius-50 u-white u-input-2" required="" runat="server"> </asp:TextBox>
                ...
                <div class="u-form-group u-form-password u-label-top">
                  <label for="firstname" class="u-label u-label-2">First Name *</label>
                  <asp:TextBox placeholder="Enter your Name" id="firstname" name="firstname" class="u-border-8 u-border-white u-input u-input-rectangle u-radius-50 u-white u-input-2" required="" runat="server"> </asp:TextBox>
                ...
                <div class="u-form-group u-form-password u-label-top">
                  <label for="lastname" class="u-label u-label-2">Last Name *</label>
                  <asp:TextBox placeholder="Enter your Surname" id="lastname" name="lastname" class="u-border-8 u-border-white u-input u-input-rectangle u-radius-50 u-white u-input-2" required="" runat="server"> </asp:TextBox>
                ...
                <div class="u-align-left u-form-group u-form-submit u-label-top">
                  <asp:Button id="SignUpButton" class="u-form-control-hidden" Text="Submit" onClick="SignUpButton_Click" runat="server"/>
                  <a href="#" class="u-active-white u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-white u-palette-2-base u-radius-50 u-text-active-palette-2-base u-text-hover-palette-2-base u-btn-1">Submit</a>
                </div>
              </form>
            </div>
